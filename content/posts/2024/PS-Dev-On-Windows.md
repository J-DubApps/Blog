...
type = 'post'
tags = ["tech", "powershell", "devops", "microsoft", "code", "windows", "beginner-fundamentals", "enterprise-it", "best-of", "walk-thru", "apps-that-i-like"]
+++
...
There's lots more to discover and tweak in VS Code, but this gets you started. I recommend any next-steps be writing up a few scripts, and just getting used to the workflow of VS Code.  Deeper learning comes with time, but for now now you're in a perfect spot with a great PowerShell setup!  There are a lot of additionl extensions (and Git / GitHub workflows you can get into later on) but the key takeaway here is that you're on a modern PowerShell dev environment, and it's all free and powerful! <br /> 
