...
+++
**Note**: This post is about *self-development* and *building confidence* when making tough calls...*or not* making them. It's *my own* thinking on the topic of "*Decision vs Choice*" from a *place of empowerment*, not necesarilly from a place of knowledge or *expertise* on the subject.  So this write-up is not not for *everyone* or "one size fits all".  *Also please note*: if you are undergoing treatment for [OCD](https://en.wikipedia.org/wiki/Obsessive–compulsive_disorder) or have the diagnosis, I would recommend skipping this write-up altogether. I can't imagine something as *intolerable* for someone with OCD, as contemplating *making choices* the way I lay it out.  It's already kind of a stretch for non-OCD folks! <br />

 <img src="https://julianwest.me/Blog/posts/images/decision-vs-choice.jpg" alt="Alt text" width="500" height="235">

I recently witnessed a friend hitting an indecisive moment, about something fairly mundane: trying to pick what to cook a few friends for dinner, and if there was time for a grocery store run. It was a pretty ordinary moment all of us go through, when entertaining guests (especially since we're all getting used to having friends visit again, post-Covid).  But in my friend's case, he kept second-guessing himself and adding new options/ideas for what *might be good* to cook for dinner. Just as quickly as he setted on a meal that seemed to please everybody, he would find x or y reasons why that meal option might *not work*. This wavering, about what to cook, went on for several minutes-and it became THE topic of discussion for nearly half an hour-with everybody making suggestions to ease our friend's amusing moment of *indecision*.<br />

Now if you know *me*, then you know that I have a hard seeing indecision-*especially* if it's for something not-too-important, but still taking up a lot of time and energy. My friend [*vascillated*](https://en.wiktionary.org/wiki/vacillate) between so many options-each option with its own data pont-that I felt compelled to ask if he was ok. I mean, we *all* have our moments of indecision, it's ***ok*** and very human; however, his moment of ***indecisiveness*** seemed to be one of many during our weekend visit.  This kind of thing may be nothing, but it sometimes can also signal a deeper issue with anxiety or self doubt happening-both things we don't like seeing close friends go through. So after everything got settled, I pulled my friend aside and walked him through an exercise that a mentor once taught me: on distinguishing ***deciding*** from ***choosing*** during moments of indecision. And I am going to try and distill that lesson here in this post.<br /> <br />
...
So we just defined what a ***decision*** is.  A ***choice***, on the other hand, *simply* ***is***. It doesn’t always come with a mental checklist or a bullet-point rationale. Instead of an exercise in logic, a ***choice*** can be an act of *creation*—giving life to something new, opening doors you hadn’t previously considered. <br />
...
It is tempting to still ***give reasons*** when *making a* ***choice***-but *strictly-speaking*: adding a lot of considerations and reasons turns your ***choice*** ---> *into* a ***decision***.  That's totally ***OK***, but now you've moved into the ***decision*** realm-so you may want to ask yourself: "am I doing something creative or low-stakes?" -- becuase, if not, then switching to a ***decision*** makes sense. But sometimes we "*slip into*" ***decision-mode*** without even realizing it, and intentionally *not* ***deciding*** is what ***choosing is all about***. 😉  Your mileage may vary, but sometimes we *should* examine a ***choice*** we're making-to make sure we ***are choosing***...or does it need to really *be* a ***decision*** instead?  <br />
