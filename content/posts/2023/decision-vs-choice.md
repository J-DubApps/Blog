...
+++
**Note**: This post is about *self-development* and *building confidence* when making tough calls...*or not* making them. It's *my own* thinking on the topic of "*Decision vs Choice*" from a *place of empowerment*, not necesarilly from a place of *expertise* on the subject.  What I talk about below is simply a *mental framework* for *how to look at decisions* from a different angle. So this write-up is not for *everyone* or a "one size fits all" thing, but was a bit of a *breakthrough* for me many years ago.  *Also please note*: if you are undergoing treatment for [OCD](https://en.wikipedia.org/wiki/Obsessive–compulsive_disorder) I would recommend skipping this write-up, because I feel like the concepts in this framework might be a little stressful if you're managing OCD.  But no worries, if you want to read on anyway! <br />
