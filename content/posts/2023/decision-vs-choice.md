...
**Additional Note**: if you are undergoing treatment for [OCD](https://en.wikipedia.org/wiki/Obsessive–compulsive_disorder) maybe skip this write-up for now, because I feel like this framework might feel stressful if you're managing OCD.  But no worries if you want to read on, anyway! <br />
