...
+++
**Note**: This post is about *self-development* and *building confidence* when making tough calls...*or not* making them. It's *my own* thinking on the topic of "*Decision vs Choice*" from a *place of empowerment*, not necesarilly from a place of *expertise* on the subject.  What I talk about below is simply a *mental framework* for how to look at decisions from another angle. So this write-up is not for *everyone* or a "one size fits all" thing, but was a bit of a *breakthrough* for me many years ago.  *Also please note*: if you are undergoing treatment for [OCD](https://en.wikipedia.org/wiki/Obsessive–compulsive_disorder) I would recommend skipping this write-up, because I feel like the concepts in this framework might be a little stressful if you're managing OCD.  But also, no worries if you want to read on! <br />

 <img src="https://julianwest.me/Blog/posts/images/decision-vs-choice.jpg" alt="Alt text" width="500" height="235">

I recently witnessed a friend hitting an indecisive moment, about something fairly mundane: trying to pick what to cook friends for dinner, and if there was time for a grocery store run...what pairs well with a cabernet...etc.  It was a pretty ordinary moment all of us go through, when entertaining guests; however, in my friend's case he kept second-guessing himself and adding new options/ideas for what *might be good* to for dinner. And just *as quickly* he would dismiss a meal idea. He would find x or y reasons why a meal option might *not work*-and it was back to discussing options for dinner. This wavering, about what to cook, went on for several minutes-and became THE topic of discussion for nearly half an hour-with everybody making suggestions to ease our friend's amusing moment of *indecision*.<br />

Now if you know *me*, then you *know* that I have a hard time seeing indecision-*especially* if it's for something not-too-importan...yet taking up time and energy. My friend [*vascillated*](https://en.wiktionary.org/wiki/vacillate) between so many options-each option with its own data pont-that I felt compelled to ask if they're ok. I mean, we *all* have our moments of indecision, it's ***ok*** and very human; however, his moment ***indecisiveness*** seemed to be one of many during our visit.  This kind of thing may be nothing, but sometimes it also signals a deeper issue with anxiety or self doubt-both things we don't like seeing close friends go through. So after everything got settled, I pulled my friend aside and walked him through an exercise that a mentor once taught me: on distinguishing ***deciding*** from ***choosing*** during moments of indecision. And I am going to try and distill that lesson here *in this post*.<br /> <br />
...
We often sell ourselves short from new opportunities or possibilities, simply because we are worried about making the “***wrong decision***”.  We’ve all been there—torn between multiple paths, searching for ***reasons*** or ***justifications*** to confirm we’ve made the *smartest move*. <br /> 

**But what if we *shifted* our perspective, here**?  What if there is a meaningful ***distinction*** to be made *between* ***making a decision***...and ***exercising a choice***?  And what if I told you that **recognizing that difference gives us new avenues of freedom and confidence**? <br />

Interested? To get rolling we *first* need to define *the two big terms here* (*Decision* & *Choice*), so that we can identify the powerful ***distinction*** I am talking about: the distinction *between* ***decision*** and ***choice***-let's go!
