...
Ultimately the <i>location</i> where Knowledge Work is done had long become a flexible thing for tech workers in many roles, <i>years before</i> Covid lockdowns increased our awareness that work could be separated from co-location.  But also, where you work is up to the company you work at, and rank-and-file and tech staff like myself have no real say here; however, the marketplace for IT jobs <i>does</i> have a say.  Even with the metric shift of instability in tech jobs going on, I still see and hear about tech colleagues taking opportunities where Remote Work has become a standard.  As expected, offering remote or WFH has become <a href="https://sloanreview.mit.edu/article/return-to-office-mandates-how-to-lose-your-best-performers/#:~:text=The%20Real%20Impact%20of%20Return%2Dto%2DOffice%20Mandates&text=Forcing%20people%20who%27ve%20been,according%20to%20Future%20Forum%20research.">a very difficult perk to remove</a>.<br />
...
The push to mandate a return-to-office policy (for IT and tech workers, anyway) is increasingly at odds with the realities of modern business and employee expectations. For decades, technology professionals have been tethered to physical offices, battling long commutes, distractions, and less-than-ideal working conditions. Now, after having proven the viability of remote work—sometimes under extremely challenging circumstances, many organizations are missing a crucial opportunity to retain top talent and maximize productivity by insisting that everyone come back to a communal office space full-time.<br />
...
Not all IT jobs are suited for full-time remote work. Certain technician roles must interact physically with hardware, and even network engineers must interact with networking equipment or sensitive hardware installations. Yet even these jobs can often be structured as a hybrid model -- but it requires task-management and planning to handle hands-on tasks, dividing what taskwork can be worked on remotely. By acknowledging that not all IT roles are identical and granting flexibility where possible, companies demonstrate respect for individual circumstances, leading to stronger job satisfaction, reduced turnover, and sustained productivity gains.<br />
 ...
 At any rate, I enjoy the benefits of Remote Work currently, in my enterprise IT role, and with my own 1.5 to 2-hour commute to my employeer's main office...I have understandably come to appreciate the days that I can work remotely.  
