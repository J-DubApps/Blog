...
As human beings with powerful minds and ***language***, we should understand that we can never experience “*pure territory*”—we're *always* experiencing the ***map***.  Our task is learning to notice when we’re mistaking our mental model for absolute *truth*—and stay open to revising our mental *maps*!  Just remember other "*cartographers*" vie for our attention (news anchors, thought leaders, politicians etc) and we can conflate another's ***maps*** (or even our own) with actual (*reality itself*) with ***territory***. Some people may be good *mapmakers*, just be wary of anyone saying their ***map*** gives you actual *objective reality*—the *raw data* of the ***territory***: nobody can do that, but you *yourself*! As I said before: **The territory* *experienced* is *better* than the territory *believed***!
