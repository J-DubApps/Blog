...
As human beings with powerful minds and ***language***, we should understand that we can never experience “*pure territory*”—we're *always* experiencing the ***map***.  Our work is learn to notice when we’re mistaking our mental model (our perceptions, *interpretations*, etc) for any absolute *truth*—and stay open to revising our mental *maps*!  Just remember many other "*cartographers*" vie for our attention (news anchors, thought leaders, politicians etc), and we can conflate another's ***maps*** (or even our own) with actual *reality itself* (***territory***). Some people may be good *mapmakers*, just be wary of those who say their own ***map*** gives you actual *objective reality*—the *raw data* of the ***territory***: nobody can do that (or should do that) but you *yourself*! 
